 ...
 * 
 * Ao final conseguiremos ordenar o trecho que quisermos no array.
 * */

public class TestaOrdenaUnicoArrayRefatorado {
	...
	public static void main(String[] args) {
		...
		//Mas se o array recebido estiver completamente desordenado?
